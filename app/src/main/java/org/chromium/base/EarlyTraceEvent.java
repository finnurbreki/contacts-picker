...
public class EarlyTraceEvent {
    ...
    private static long getOffsetNanos() {
        long nativeNowNanos = 0; // TimeUtils.nativeGetTimeTicksNowUs() * 1000;
    ...
    private static void nativeRecordEarlyEvent(String name, long beginTimNanos,
                                                      long endTimeNanos, int threadId, long threadDurationMillis) {}
    private static void nativeRecordEarlyStartAsyncEvent(
            String name, long id, long timestamp) {}
    private static void nativeRecordEarlyFinishAsyncEvent(
            String name, long id, long timestamp) {}
}
